            ...
            if (res.user) {
                ...
                if (res.user.isAdmin) {
                    ...
                    if (res.user.award == null || res.user.award == undefined) {
                        ...
                        text = 'לצערנו סך השאלות ספריך בשנת 2016 לא הגיע לרף המינימאלי הדרוש לקבלת זכאות לתשלומים ממשרד התרבות.';
                    } else {
                        text = 'הננו מתכבדים להודיעך כי ע"פ תוצאות סקר הסופרים המעודכן שבוצע בספריות הציבוריות לשנת 2016 מתוכנן לשלם לך סך ' + 
